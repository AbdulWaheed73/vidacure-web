...
export const LoginPage: React.FC<LoginPageProps> = ({ onLogin, loading }) => {
  ...
  return (
    <div className="w-full h-[1024px] relative bg-emerald-50 overflow-hidden">
      <div className="w-full px-5 left-0 top-0 absolute bg-white shadow-[0px_1px_4px_0px_rgba(12,12,13,0.05)] shadow-[0px_1px_4px_0px_rgba(12,12,13,0.10)] inline-flex flex-col justify-center items-start gap-2.5">
        <div className="w-[1280px] p-5 inline-flex justify-start items-center gap-8">
          <div className="size-6 relative overflow-hidden">
            <div className="size-4 left-[4px] top-[4px] absolute " > <ArrowLeft  /> </div>
          </div>
          <div className="size- relative flex justify-start items-center gap-12">
            <img
              className="w-36 h-6 left-0 top-0 absolute"
              src={vidaCure}
            />
          </div>
        </div>
      </div>
      <div className="w-[806px] px-12 py-16 left-[317px] top-[295.32px] absolute bg-white rounded-2xl shadow-[0px_4px_10px_0px_rgba(0,0,0,0.08)] shadow-[0px_18px_18px_0px_rgba(0,0,0,0.07)] shadow-[0px_40px_24px_0px_rgba(0,0,0,0.03)] shadow-[0px_71px_29px_0px_rgba(0,0,0,0.01)] shadow-[0px_112px_31px_0px_rgba(0,0,0,0.00)] outline outline-1 outline-stone-50 inline-flex flex-col justify-center items-center gap-8">
        ...
        <div className="self-stretch flex flex-col justify-center items-center gap-2.5">
          <div className="size- p-3.5 bg-white rounded-[10px] shadow-[0px_2px_3px_0px_rgba(0,0,0,0.17)] shadow-[0px_0px_3px_0px_rgba(0,0,0,0.08)] inline-flex justify-center items-center gap-3.5">
            <img className="w-10 h-9" src={bankId} />
            <div className="justify-start text-black/50 text-xl font-medium font-['Roboto']" onClick={onLogin}>

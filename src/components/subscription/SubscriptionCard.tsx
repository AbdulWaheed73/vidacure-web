        ...
        <div className="self-stretch flex-1 flex flex-col justify-start items-start gap-6 sm:gap-8">
          ...
          <div className="self-stretch flex flex-col justify-start items-start gap-4 sm:gap-8">
            <div className="justify-center">
              <span className="text-zinc-800 text-4xl sm:text-5xl font-bold font-['Sora'] leading-tight sm:leading-[56.40px]">{planDetails.price} </span>
              <span className="text-zinc-800 text-xl sm:text-2xl font-bold font-['Sora'] leading-loose">{planDetails.currency}/mo</span>
            </div>
            <div className="self-stretch justify-center text-zinc-800 text-lg sm:text-xl font-bold font-['Sora'] leading-relaxed">{planDetails.description}</div>
          </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-3 sm:gap-4">
              {planDetails.features.map((feature, index) => (
                <div key={index} className="self-stretch inline-flex justify-start items-center gap-3 sm:gap-6">
                  ...
                  <div className="flex-1 justify-center text-zinc-800 text-sm sm:text-base font-normal font-['Manrope'] leading-snug">{feature}</div>
                </div>
              ))}
            </div>
          </div>
    ...
    return (
      <div className="flex-1 w-full md:w-auto self-stretch p-5 sm:p-8 rounded-2xl shadow-[0px_2px_3px_0px_rgba(0,0,0,0.17)] inline-flex flex-col justify-start items-start gap-8 sm:gap-16 relative" style={{ backgroundColor: '#005044' }}>
        ...
        <div className="self-stretch flex flex-col justify-start items-start gap-6 sm:gap-8">
          ...
          <div className="self-stretch flex flex-col justify-start items-start gap-4 sm:gap-8">
            <div className="justify-center">
              <span className="text-white text-4xl sm:text-5xl font-bold font-['Sora'] leading-tight sm:leading-[56.40px]">{planDetails.price} </span>
              <span className="text-white text-xl sm:text-2xl font-bold font-['Sora'] leading-loose">{planDetails.currency}/mo</span>
            </div>
            <div className="self-stretch justify-center text-white text-lg sm:text-xl font-bold font-['Sora'] leading-relaxed">{planDetails.description}</div>
          </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-3 sm:gap-4">
              {planDetails.features.map((feature, index) => (
                <div key={index} className="self-stretch inline-flex justify-start items-center gap-3 sm:gap-6">
                  ...
                  <div className="flex-1 justify-center text-emerald-50 text-sm sm:text-base font-normal font-['Manrope'] leading-snug">{feature}</div>
                </div>
              ))}
            </div>
          </div>
